    ...
    <><div id="outer-container" >
      ...
      <div id="page-wrap">
        <div className={`mx-auto  ${router.pathname === '/' ? 'topPage' : null}`}>
          ...
          <header className="mb-10 md:mb-20 g:mb-24 px-6 md:px-8 lg:px-10 pt-6 md:pt-8 lg:pt-10">
            <div className="flex w-full justify-between items-center">
              <div className="md:duration-500 md:hover:opacity-40">
                <Link href="/" passHref>
                  <a>
                    <p className="title-jp md:text-2xl z-20 mt-1 md:mt-0">髙橋昌之建築設計事務所</p>
              ...
              <div className="hidden md:block flex items-center">
                <ul className="flex justify-end text-sm">
                  ...
                  <li className={`${router.pathname == '/contact' ? 'opacity-40' : ' '} hover:opacity-40 md:duration-500`}>
